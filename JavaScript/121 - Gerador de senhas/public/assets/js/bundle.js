...
var qtdCaracteres = document.querySelector('.qnt-caracteres');
...
function gera() {
  var senha = (0,_geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(qtdCaracteres.value, chkMaiuscula.checked, chkMinuscula.checked, chkNumeros.checked, chkSimbolos.checked);
...
function geraSenha(qnt, maiuscula, minuscula, numeros, simbolos) {
  var senhaArray = [];
  var quantidade = Number(qnt);
